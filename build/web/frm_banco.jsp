...
<!DOCTYPE html>
<html>
    <a href="../src/java/controladores/ControladorBanco.java"></a>
    <head>
        ...
        <script>
            function registrar(){
                ...
                $.post("controladorbanco?operacion=nuevoGuardar", params, function(datos){
                    $("#show").html(datos);
                },"html");
    ...
    <body>
        ...
        <div class="panel panel-primary" style="margin-top: 60px">
            <div class="panel-heading"><h4><span class="fa fa-bank" style="color: #fff; padding: 5px"></span> Registro de Banco</h4></div>
