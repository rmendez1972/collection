                    ...
                    <form id="form_DE" onsubmit="return registrar()"  class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-md-2">
                                <input type="text" name="descripcion" class="form-control"  id="descripcion" pattern="([a-zA-ZñÑáéíóúÁÉÍÓÚ#.\0-9]{5,50})"  maxlength="50"  placeholder="Max. 50 caracteres" required style=" text-transform:uppercase; width: 300px; font-size: 25px " value="${del.descripcion}" />
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-md-2">
                                <input type="text" name="direccion" class="form-control" id="direccion" pattern="([a-zA-ZñÑáéíóúÁÉÍÓÚ#.\0-9]{5,80})"  maxlength="80"  placeholder="Max. 80 caracteres" required style="text-transform:uppercase; width: 300px; font-size: 25px" value="${del.direccion}" />
                            </div>
                        </div>
