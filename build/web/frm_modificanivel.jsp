                    ...
                    <form id="form_UA" onsubmit="return registrar()"  class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-md-2">
                                <input type="text" name="descripcion" class="form-control"  id="descripcion" pattern="([a-zA-ZñÑáéíóúÁÉÍÓÚ]{4,50})"  placeholder="Max. 50 caracteres"  maxlength="50" required style="text-transform:uppercase; width: 300px; font-size: 25px" value="${niveles.descripcion}" />
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-md-2">
                                <input type="text" name="privilegios" class="form-control" id="privilegios" pattern="([a-zA-ZñÑáéíóúÁÉÍÓÚ]{4,80})"  placeholder="Max. 80 caracteres"  maxlength="80" required style="text-transform:uppercase; width: 300px; font-size: 25px" value="${niveles.privilegios}" />
                            </div>
                        </div>
