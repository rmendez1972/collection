    ...
    <body>
        ...
        <form id="form_UA" onsubmit="return registrar()">
            ...
            <table border="0" align="center">
                ...
                <tr>
                    <td><input type="text" id="descripcion" pattern="([a-zA-Z ]{5,50})"  placeholder="Mínimo 5 caracteres" required style="width: 300px; font-size: 25px" value="${niveles.descripcion}" /></td>
                    <td><input type="text" id="privilegios" pattern="([a-zA-Z ]{5,50})"  placeholder="Mínimo 5 caracteres" required style="width: 300px; font-size: 25px" value="${niveles.privilegios}" /></td>
                </tr>
                <tr>
