CREATE PROCEDURE sp_apertura20(IN id_benef int, IN imp_cap decimal, imp_eng decimal,IN poliza varchar(4), IN fecha_pol varchar(11), IN clave_b varchar(12),IN id_usuario int)
BEGIN
