                ...
                <div class="panel-body transparent">
                    <form id="form_CD" onsubmit="return registrar()"  class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-md-4">
                                <input type="number" step="0.01" name="importe" class="form-control" id="importe" placeholder="SÓLO SE ACEPTAN DECIMALES" maxlength="12"/>
                            </div>
                            
                            <label for="cuenta_cont" class="col-xs-12 col-md-2 control-label ">Cuenta Contabilidad:</label>
                            <div class="col-xs-12 col-md-4">
                                <input type="text" name="cuenta_cont" class="form-control" id="cuenta_cont" pattern="([a-zA-ZñÑáéíóúÁÉÍÓÚ\0-9]{1,50})"  maxlength="50" placeholder="Máx. 50 caracteres" style="text-transform:uppercase"  />
                            </div>
                        </div>
