                    ...
                    <form id="form_CD" onsubmit="return registrar()"  class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-md-2">
                                <input type="text" name="descripcion" class="form-control"  id="descripcion" pattern="([a-zA-ZñÑáéíóúÁÉÍÓÚ#.\0-9]{5,50})"  placeholder="Máx. 50 caracteres" required style=" text-transform:uppercase; width: 300px; font-size: 25px " value="${rm.descripcion}" />
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-md-2">
                                <input type="text" name="direccion" class="form-control" id="direccion" pattern="([a-zA-ZñÑáéíóúÁÉÍÓÚ#.\0-9]{5,80})"  placeholder="Max.80 caracteres" required style="text-transform:uppercase; width: 300px; font-size: 25px" value="${rm.direccion}" />
                            </div>
                        </div>
