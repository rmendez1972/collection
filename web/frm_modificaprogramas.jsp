                ...
                <div class="panel-body transparent">
                    <form id="form_CL" onsubmit="return registrar()"  class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-md-4">
                                <input type="text" name="descripcion" class="form-control" id="descripcion" required autofocus pattern="([a-zA-ZñÑáéíóúÁÉÍÓÚ\0-9]{4,80})" maxlength="80" placeholder="Máx. 80 caracteres" style="text-transform:uppercase" value="${prog.descripcion}" />
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-md-4">
                                <input type="number" step="0.01" class="form-control" id="por_pf" required  placeholder="Sólo se aceptan tres decimales" maxlength="12" value="${prog.por_pf}" />
                            </div>
