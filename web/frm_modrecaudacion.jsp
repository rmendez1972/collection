<%-- 
    Document   : frm_modrecaudacion
    Created on : 15/06/2017, 12:21:57 PM
    Author     : Marlon
--%>
...
<html>
        ...
        <title>JSP Page</title>
         <script>
            function registrar(){
                ...
                $.post("controladormodrec?operacion=nuevoGuardar", params, function(datos){
                    $('#show').html(datos);
                },"html");
    ...
    <body>
        <div class="panel panel-primary" style="margin-top: 60px">
            <div class="panel-heading"><h4><span class="fa fa-window-restore" style="color: #fff"></span> Registro de Modulos Recaudación</h4></div>
