                    ...
                    <form id="form_FR" action="controladorfirmantes?operacion=nuevoGuardar" method="post"   class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-md-2">
                                <input type="text" name="nombre" class="form-control" id="nombre" pattern="([a-zA-ZñÑáéíóúÁÉÍÓÚ\0-9\0-9]{5,80})"  maxlength="80"  placeholder="Max 80 caracteres" required style="text-transform:uppercase; width: 300px; font-size: 25px"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-md-2">
                                <input type="text" name="cargo" class="form-control" id="cargo" pattern="([a-zA-ZñÑáéíóúÁÉÍÓÚ\0-9\0-9]{5,80})"  maxlength="80"  placeholder="Max 80 caracteres" required style="text-transform:uppercase; width: 300px; font-size: 25px"/>
                            </div>
                        </div>
