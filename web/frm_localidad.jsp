<%-- 
    Document   : frm_localidad
    Created on : 13/06/2017, 10:29:00 AM
...
<!DOCTYPE html>
<html>
    <a href="../src/java/controladores/ControladorLocalidad.java"></a>
    <head>
        ...
        <script>
            function registrar(){
                ...
                $.post("controladorlocalidad?operacion=nuevoGuardar", params, function(datos){
                    $("#show").html(datos);
                },"html");
    ...
    <body>
            ...
            <div class="panel-heading"><h4><span class="fa fa-map-marker" style="color: #fff; padding: 5px"></span> Registro de Localidad</h4></div>
