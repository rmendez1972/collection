                    ...
                    <form id="form_UA" onsubmit="return registrar()"  class="form-horizontal">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-xs-12 col-md-4">
                                <input type="text" name="clave_b" class="form-control" id="clave_b" required pattern="([a-zA-ZñÑáéíóúÁÉÍÓÚ\0-9]{4,12})"  placeholder="Máx.12 caracteres" maxlength="12" style="text-transform:uppercase" value="${edocta.clave_b}" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                           ...
                           <label for="numcontrato" class="col-xs-12 col-md-2 control-label">Número de Contrato:</label>
                            <div class="col-xs-12 col-md-4">
                                <input type="text" name="numcontrato" class="form-control" id="numcontrato" required pattern="([a-zA-ZñÑáéíóúÁÉÍÓÚ\0-9]{3,5})"  placeholder="Máx.5 caracteres" maxlength="5" style="text-transform:uppercase" value="${edocta.numcontrato}" />
                            </div>  
                        </div>
