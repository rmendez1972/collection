<%-- 
    Document   : frm_modificacolonia
    Created on : 09/06/2017, 01:33:00 PM
...
<html>
    <head>
        ...
        <script>
            function registrar(){
                ...
                $.post("controladorcolonia?operacion=editarGuardar", params, function(datos){
                    $("#show").html(datos);
                },"html");
    ...
    <body>
        <div class="panel panel-primary" style="margin-top: 60px">
            <div class="panel-heading"><h4><span class="fa fa-building" style="color: #fff; padding: 5px"></span>Modificar Colonia</h4></div>
                <div class="panel-body transparent">
                    <form id="form_CL" onsubmit="return registrar()"  class="form-horizontal">
                        <input type="hidden" name="id_colonia" id="id_colonia" value="${colonia.id_colonia}" />
            
                        <div class="form-group">
                            <label for="descripcion" class="col-xs-12 col-md-2 control-label col-md-offset-3">Descripcion:</label>
                            <div class="col-xs-12 col-md-4">
                                <input type="text" id="descripcion" class="form-control" required autofocus pattern="([a-zA-ZñÑáéíóúÁÉÍÓÚ\0-9]{4,80})" maxlength="80" required style="text-transform:uppercase" value="${colonia.descripcion}" />
                            ...
                            <div class="col-xs-12 col-md-4">
                                <select id="id_delegacion" required class="form-control"> 
                                    ...
                                    <c:forEach  var="delegacion" items="${requestScope.delegaciones}">
                                        <OPTION VALUE="${delegacion.id_delegacion}" ${delegacion.id_delegacion == colonia.id_delegacion ? 'selected':''}>${delegacion.descripcion}</OPTION>
                                    </c:forEach>
                                </select>
                            </div>
                        </div>
