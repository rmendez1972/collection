...
public class GestionCandidatos
{
    ...
    public boolean registroCandidatos(Candidatos candidatos){
        ...
        Object params[]={id_catprog, numcontrato,clave_elect,curp,rfc,nombre,conyuge,fecha_con,mza,lte,area,domicilio,clave_cat,id_tipocredito};
        return Conexion.ejecutar("insert into candidatos (id_catprog, numcontrato,clave_elect,curp,rfc,nombre,conyuge,fecha_cont,mza,lte,area,domicilio,clave_cat,id_tipocredito) values (?,?,?,?,?,?,?,?,?,?,?,?,?,?)", params);
    }
    ...
    public boolean actualizarCandidatos(Candidatos candidatos){
        ...
        Object params[]={id_catprog,numcontrato,clave_elect,curp,rfc,nombre,conyuge,fecha_con,mza,lte,area,domicilio,clave_cat,id_tipocredito,id_candidato};
        return Conexion.ejecutar("update candidatos set id_catprog=?, numcontrato=?, clave_elect=?, curp=?, rfc=?, nombre=?, conyuge=?, fecha_cont=?, mza=?, lte=?, area=?, domicilio=?, clave_cat=?, id_tipocredito=? where id_candidato=?", params);
    }
    ...
    public boolean actualizaraperturaCandidatos(Candidatos candidatos){
        ...
        //String fecha_ip=sdf.format(candidatos.getFecha_ip());
        Integer id_candidato=candidatos.getId_candidato();
        Object params[]={poliza,fecha_pol,id_candidato};
        return Conexion.ejecutar("update candidatos set poliza=?, fecha_pol=? where id_candidato=?", params);
    }
