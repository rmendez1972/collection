...
public class GestionCandidatos
{
    ...
    public boolean registroCandidatos(Candidatos candidatos){
        ...
        Object params[]={id_catprog, numcontrato,clave_elect,curp,rfc,nombre,conyuge,fecha_con,mza,lte,area,domicilio,clave_cat,id_tipocredito,id_usuario,clave_b};
        return Conexion.ejecutar("insert into candidatos (id_catprog, numcontrato,clave_elect,curp,rfc,nombre,conyuge,fecha_cont,mza,lte,area,domicilio,clave_cat,id_tipocredito,id_usuario,clave_b) values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)", params);
    }
    ...
    public boolean actualizarCandidatos(Candidatos candidatos){
        ...
        Integer id_usuario=candidatos.getId_usuario();
        String clave_b=candidatos.getClave_b();
        Object params[]={id_catprog,numcontrato,clave_elect,curp,rfc,nombre,conyuge,fecha_con,mza,lte,area,domicilio,clave_cat,id_tipocredito,id_usuario,id_candidato,clave_b};
        return Conexion.ejecutar("update candidatos set id_catprog=?, numcontrato=?, clave_elect=?, curp=?, rfc=?, nombre=?, conyuge=?, fecha_cont=?, mza=?, lte=?, area=?, domicilio=?, clave_cat=?, id_tipocredito=?, id_usuario=?, clave_b=? where id_candidato=?", params);
    }
