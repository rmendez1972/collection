...
public class GestionBendiv {
    ...
    //17-04-2018. Obtener beneficiario diverso por curp
    public BeneficiarioDiv obtenerPorClave_curp(String clave_b){
        BeneficiarioDiv beneficiario=null;
        Object params[]={clave_b};
        ResultSet res=Conexion.ejecutarConsulta("select * from benef_div where curp=?", params);
        try{
            if(res.next())
